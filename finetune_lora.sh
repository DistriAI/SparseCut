...
deepspeed llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/llava-v1.5-7b-pretrain-residual-$ResidualSTEP/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b-res-${ResidualSTEP}-lora \
    --num_train_epochs 1 \
